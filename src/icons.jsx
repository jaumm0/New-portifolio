...
function Icons() {
    return(
        <div>
             ...
             <ul className="flex flex-row justify-center items-center mt-10  gap-5 ">
                <li className="bg-yellow-700 w-11 h-11 rounded-full flex justify-center items-center  relative bottom-45 right-56 duration-300 ease-out hover:bg-amber-700 hover:scale-105 transition-all 2s cursor-pointer">
                    <a onClick={() => window.open("/New-portifolio/", "_blank")} href="https://www.linkedin.com/in/joaoanjoadev/" className="  flex justify-center w-10">
                ...
                <li className="bg-yellow-700 w-11 h-11 rounded-full flex justify-center items-center  relative bottom-45 right-56 duration-300 ease-out hover:bg-amber-700 hover:scale-105 transition-all 2s cursor-pointer" >
                    <a onClick={() => window.open("/New-portifolio/", "_blank")} href="https://github.com/jaumm0">
                        <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                <li className="bg-yellow-700 w-11 h-11  rounded-full flex justify-center items-center  relative bottom-45 right-56 duration-300 ease-out hover:bg-amber-700 hover:scale-105 transition-all 2s cursor-pointer" >
                    <a onClick={() => window.open("/New-portifolio/", "_blank")} href="https://api.whatsapp.com/send?phone=5567993404143&text=Ol%C3%A1,%20Joao%20victor">
                        <svg xmlns="http://www.w3.org/2000/svg" 
                        width="24" 
                        height="24" 
                        viewBox="0 0 24 24" 
